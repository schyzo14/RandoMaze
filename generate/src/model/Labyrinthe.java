...
public interface Labyrinthe extends Remote {
	...
	public boolean updatePersonnage(int id, String nom, int pointvie,
			int idpiece) throws MalformedURLException, RemoteException,
			NotBoundException;

	public Piece getPieceById(int idPiece) throws MalformedURLException,
	...
	public void setListeMap(HashMap<String, Maze> listeMap)
