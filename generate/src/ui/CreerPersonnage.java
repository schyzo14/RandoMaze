...
public class CreerPersonnage extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 256312646597022897L;
		...
		jPanel1Layout
				.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								jPanel1Layout.createSequentialGroup().addGap(75, 75, 75)
										.addComponent(b_annuler, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addGap(96, 96, 96)
										.addComponent(b_creer, javax.swing.GroupLayout.DEFAULT_SIZE, 77,
												Short.MAX_VALUE)
										.addGap(75, 75, 75))
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(44, 44, 44)
								.addComponent(l_nomPers, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(99, 99, 99)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(tf_nomPers, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(l_nomPers, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(75, 75, 75)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(b_creer, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(b_annuler, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(83, 83, 83)));
	 ...
	 */
	private void b_annulerMouseClicked(java.awt.event.MouseEvent evt)
	 ...
	 * @throws NotBoundException
	 */
	private void b_creerMouseClicked(java.awt.event.MouseEvent evt)
			throws MalformedURLException, RemoteException, NotBoundException {
		...
		if (tf_nomPers.getText().trim().length() <= 0) {
			...
			// Si la création du personnage n'a pas pu avoir lieu, message
			// d'erreur
			// Sinon on affiche la fenêtre de sélection des personnages
			if (result == false) {
				System.out.println(
						"Problème de création de personnage - Nom de personnage déjà existant ou autre erreur... ");
				Util.afficherPopUp(
						"Problème de création de personnage - Nom de personnage déjà existant ou autre erreur...");
			} else {
	...
	public void quitterFenetre() throws RemoteException, MalformedURLException, NotBoundException {
		...
		// S'il n'y a pas d'autres fenêtres ouvertes, on peut fermer le serveur,
		// et la fenêtre
		if (!ouvert) {
			Labyrinthe laby = (Labyrinthe) Naming.lookup("MonServeur1");
			laby.quitter();
